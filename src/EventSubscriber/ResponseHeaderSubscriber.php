...
class ResponseHeaderSubscriber implements EventSubscriberInterface
{
    ...
    public function onKernelResponse(ResponseEvent $event)
    {
        ...
        $response->headers->add([
            ...
            'Content-Security-Policy' => "default-src 'self'; script-src 'self' 'unsafe-inline' $matomoUrl ; style-src 'self' 'unsafe-inline'; img-src * data:; frame-src https: youtube.com; child-src https: youtube.com; object-src 'none'; frame-ancestors 'none'; connect-src 'self' $matomoUrl", // https://infosec.mozilla.org/guidelines/web_security#content-security-policy
