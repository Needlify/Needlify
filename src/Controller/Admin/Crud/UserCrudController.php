...
class UserCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions
    {
        return $actions
            ...
            ->update(Crud::PAGE_INDEX, Action::DELETE, fn (Action $action) => $action->displayIf(fn (User $user) => $user !== $this->getUser()))
            ->update(Crud::PAGE_DETAIL, Action::DELETE, fn (Action $action) => $action->displayIf(fn (User $user) => $user !== $this->getUser()))
