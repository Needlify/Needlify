...
class TagCrudController extends AbstractCrudController
{
    ...
    {
        $goToAction = Action::new('goTo', 'admin.crud.action.view_tag')
            ->linkToUrl(fn (Tag $tag) => $this->urlGenerator->generate('app_tag', ['slug' => $tag->getSlug()]));

        $actions
            ->update(Crud::PAGE_INDEX, Action::NEW, fn (Action $action) => $action->setLabel('admin.crud.tag.actions.create'))
